...
$t->get_ok('/goodbye.txt')->status_is(200)->content_is("Goodbye Mojo from a static file!\n");
...
$t->get_ok('/goodbye.txt' => {'Accept-Encoding' => 'br, gzip'})->status_is(200)
    ->header_is('Content-Encoding' => 'br')->header_is(Vary => 'Accept-Encoding')
...
$t->get_ok('/goodbye.txt' => {'Accept-Encoding' => 'gzip'})->status_is(200)
    ->header_is('Content-Encoding' => 'gzip')->header_is(Vary => 'Accept-Encoding')
